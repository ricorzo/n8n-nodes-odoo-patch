...
class Odoo {
                ...
                async getModelFields() {
                    ...
                    const options = Object.entries(responce).map(([key, field]) => {
                        ...
                        return {
                            ...
                            value: key,
                            description: `name: ${key}, type: ${optionField === null || optionField === void 0 ? void 0 : optionField.type} required: ${optionField === null || optionField === void 0 ? void 0 : optionField.required}`,
                        };
                    });
    ...
    async execute() {
        ...
        if (blockedOperations.includes(operation)) {
            throw new NodeOperationError(this.getNode(), 'Esta versión corporativa permite únicamente operaciones de lectura.');
        }
        const credentials = await this.getCredentials('odooApi');
            ...
            try {
                ...
                if (resource === 'custom') {
                    ...
                    if (operation === 'action') {
                        ...
                        responseData = await GenericFunctions_1.odooAction.call(this, db, userID, password, customResource, actionName, url, customResourceId);
                    }
                }
                if (resource === 'note') {
                    if (operation === 'create') {
