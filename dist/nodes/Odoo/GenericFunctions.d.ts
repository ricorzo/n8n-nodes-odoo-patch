...
export declare function odooAction(this: IHookFunctions | IExecuteFunctions | IExecuteSingleFunctions | ILoadOptionsFunctions, db: string, userID: number, password: string, resource: string, actionName: string, url: string, itemsID: string): Promise<IDataObject | IDataObject[]>;
